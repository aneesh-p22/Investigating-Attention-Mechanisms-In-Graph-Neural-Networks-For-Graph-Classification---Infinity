...
print()
print("GATv2 parameterisation:")
print("First convolution share_weights:", model.conv1.share_weights)
print("Second convolution share_weights:", model.conv2.share_weights)

print(
    "First convolution transformations shared:",
    model.conv1.lin_l is model.conv1.lin_r,
)

print(
    "Second convolution transformations shared:",
    model.conv2.lin_l is model.conv2.lin_r,
)
